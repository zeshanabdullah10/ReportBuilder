...
import { Database, Check, AlertTriangle, X } from 'lucide-react'
    ...
    <div className={cn('relative', className)}>
      <div className="relative flex items-center">
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            'w-full bg-[#050810] border border-[rgba(0,255,200,0.2)] rounded-md px-2 py-1.5 pr-16',
        ...
        <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-0.5">
          ...
          {value && validation && (
            <span className="flex-shrink-0" title={!validation.valid ? validation.error : undefined}>
              {validation.valid ? (
